    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-neutral border border-border rounded-2xl p-8 shadow-2xl">
              {/* Close button */}
              <button
                onClick={onClose}
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">
                  Welcome to <span className="text-innovation">Tesseract</span>
                </h2>
                <p className="text-zinc-400 text-sm">
                  {message || 'Sign in to unlock personalized AI assistance'}
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-neutral px-2 text-zinc-500">or</span>
                  </div>
                </div>
